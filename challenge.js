...
window.PipChallenge = (() => {
  ...
  const bosses = {
    ...
    3: { id:'cloud-kraken',name:'The Cloud Kraken',theme:'kraken',assetId:'cloud-kraken',hazard:'squall',music:'boss-kraken',timerMs:{learning:15000,classic:15000},count:5,targetHits:{learning:5,classic:5},right:5,stages:1,kind:'noun',label:'Clear the rain ribbons',intro:'The rain will wash your words away!',attack:'Storm surge!',hint:'A noun names a person, place, animal or thing.',defeat:'The storm is clearing...' },
  ...
  function checkpoint(mode,phase,stage=0){
    ...
    const cues={moss:{windupMs:550,sfxPeakMs:300},kraken:{windupMs:650,sfxPeakMs:100},gale:{windupMs:650,sfxPeakMs:450},volcano:{windupMs:600,sfxPeakMs:150}};
    return {...base,...round,...cues[base.theme],stage:safeStage,stages:learning?1:base.stages,targetHits:totalHits,right:learning&&phase===5?10:round.right,timerMs:base.timerMs[learning?'learning':'classic'],learning};
  }
