...
window.PipChallenge = (() => {
  'use strict';
  const bosses = {
    2: { id:'spore-bramble',name:'The Spore Bramble',theme:'moss',assetId:'spore-bramble',hazard:'bramble',music:'boss-moss',timerMs:{learning:18000,classic:12000},count:5,targetHits:{learning:3,classic:3},right:3,stages:1,kind:'verb',label:'Wake the sleepy words',intro:'Who disturbs my moss?',attack:'My brambles are growing!',hint:'Look for doing words. What can someone do?',defeat:'Ah... my vines rest...' },
    3: { id:'cloud-kraken',name:'The Cloud Kraken',theme:'kraken',assetId:'cloud-kraken',hazard:'squall',music:'boss-kraken',timerMs:{learning:17000,classic:11000},count:5,targetHits:{learning:5,classic:5},right:5,stages:1,kind:'noun',label:'Clear the rain ribbons',intro:'The rain will wash your words away!',attack:'Thunder rolls. Choose a naming word!',hint:'A noun names a person, place, animal or thing.',defeat:'The storm is clearing...' },
