...
Teacher review: assess the inherited adverb entries bad, mad, strict, swift, soft,
smart and quick and their examples for this class's curriculum. Flag nonstandard
or confusing uses and propose clear alternatives; do not change catalogue IDs or
delete image assets. Review should preserve existing homograph acceptance.

Return only reproducible findings: device/browser, exact actions, expected versus
actual result, screenshot where useful, and severity. Separate subjective voice/
art preferences from functional bugs. If everything checked is satisfactory,
say so briefly and list any untested items. Do not spend image-generation credits.
